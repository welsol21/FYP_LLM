    ...
    def test_extract_translation_probe_stats_counts_node_coverage(self):
        result = {
            "She trusted him.": {
                ...
                "translations": {"m2m100": {"source_lang": "en", "target_lang": "ru", "model": "m2m100", "text": "Она ему доверяла."}},
                "linguistic_elements": [
                    {
                        "type": "Phrase",
                        "content": "trusted him",
                ...
                "linguistic_elements": [
                    {
                        "type": "Phrase",
                        "content": "trusted him",
                        "translations": {"m2m100": {"source_lang": "en", "target_lang": "de", "text": "vertraute ihm"}},
                        "linguistic_elements": [
